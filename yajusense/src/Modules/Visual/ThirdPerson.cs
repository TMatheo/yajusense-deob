...
public class ThirdPerson : BaseModule
{
    ...
    public ThirdPerson() : base("ThirdPerson", "Back view camera", ModuleCategory.Visual) { }
    ...
    private void UpdateCameraPosition()
    {
        ...
        _tpCameraBack.transform.position = _referenceCamera.transform.position - _referenceCamera.transform.forward * _zoomOffset;
    }
